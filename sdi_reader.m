...
%Lee las 625 lineas de un frame completo. Si es video activo, a�ade la
%l�nea al array de y, cb, cr. Si no, lo tira.
for x = 1:625
...
%Seg�n el tipo de payload, lo tira o lo guarda porque es v�deo activo
...
function DataWord = find_EAV(FileIDIn)
  ...
  if XYZ_bin(4) == 1
      ...
      %Devuelvo el puntero al 3FF retrocedo 6 ya que he leido 2 despu�s del
      %puntero
